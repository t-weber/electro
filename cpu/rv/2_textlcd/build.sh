...
# collect all source files for ide
echo -e "\nCollecting source files into \"build/src\"..."
mkdir -p build/src
...
cp -v rv_main.sv build/src
cp -v ../../../fpga_sv/tests/pins/pins9k.cst build/src
cp -v ../../../fpga_sv/tests/pins/pins25k.cst build/src
cp -v ../../../fpga_sv/tests/pins/clocks9k.sdc build/src
cp -v ../../../fpga_sv/tests/pins/clock25k.sdc build/src
